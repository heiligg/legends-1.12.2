...
- Worldgen: Legend Ore, Nether Legend Ore, surface shrines, underground ruins
- Enchantment: **Legend Strike** (bonus magic burst on hit)
...
Jar: `build/libs/legends-2.3.0.jar`
