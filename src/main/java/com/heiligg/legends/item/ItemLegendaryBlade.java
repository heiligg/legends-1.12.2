...
public class ItemLegendaryBlade extends ItemSword {

    public ItemLegendaryBlade(ToolMaterial material) {
        super(material);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFormatting.GOLD + "Right-click: Shockwave");
        tooltip.add(TextFormatting.GRAY + "Hits inflict Weakness.");
    }
